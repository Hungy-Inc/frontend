                    ...
                    <div className="md:col-span-2">
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                            <p className="text-sm text-blue-800">
                                <strong>ℹ️ Default Password:</strong> All new users will be created with the default password <code className="bg-blue-100 px-2 py-1 rounded">password123</code>
                            </p>
                        </div>
                    </div>
                )}
